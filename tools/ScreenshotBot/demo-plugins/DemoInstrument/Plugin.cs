...
namespace TuneLab.DocsPlugins.DemoInstrument;
...
public sealed class DemoInstrumentEngine : IInstrumentSynthesisEngine, IExtensionSettings
{
    ...
    [
        InstrumentSourceLayoutItem.Group("示例合成器",
        [
    ...
    public void Init()
    {
        ...
        mInfos.Add("sine", new InstrumentSourceInfo { Name = "示例乐器 · 正弦", Description = "文档示例音源：多声部正弦" });
        mInfos.Add("square", new InstrumentSourceInfo { Name = "示例乐器 · 方波", Description = "文档示例音源：多声部方波" });
    }

    public void Destroy() { }

    public IInstrumentSynthesisSession CreateSession(IInstrumentSynthesisContext context) => new DemoInstrumentSession(context, context.InstrumentId);
...
public sealed class DemoInstrumentSession : IInstrumentSynthesisSession
{
    public DemoInstrumentSession(IInstrumentSynthesisContext context, string instrumentId)
    {
        mContext = context;
